...
import type { RentalHistoryRow } from "@/lib/vehicles/queries";

export function RentalHistoryTable({ rentals }: { rentals: RentalHistoryRow[] }) {
  if (rentals.length === 0) {
    return (
      <p className="text-sm text-muted-foreground">
        No rentals for this vehicle yet — rental creation arrives in Phase 3.
      </p>
    );
  }
